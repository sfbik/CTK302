...
function setup() {
  ...
  cari = loadImage("assets/rocketmock.png");
...
function checkForKeys() {
  ...
  if (keyIsDown(RIGHT_ARROW)) {
    frogPos.x += 7;
    cari = loadImage("assets/rocketmockRight.png");
  } 
  if (keyIsDown(UP_ARROW)) {
    frogPos.y -= 6;
    cari = loadImage("assets/rocketmockUp.png");
  } 
  if (keyIsDown(DOWN_ARROW)) {
    frogPos.y += 6;
    cari = loadImage("assets/rocketmockDown.png");
  }
}
